				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell text-align="center">
							<fo:block>
								<fo:external-graphic src="./spring-cloud-scheduler-docs/src/main/docbook/images/logo.png" width="240px"
					...
					<fo:table-row>
						<fo:table-cell text-align="center">
							...
							<fo:block font-family="Helvetica" font-size="10pt" padding="5mm" padding-before="25em">
								<xsl:text>Copyright &#xA9; 2018</xsl:text><xsl:value-of select="d:info/d:copyright"/>
							</fo:block>
	...
	<xsl:template name="footer.content">
		...
		<xsl:variable name="Title">
			<xsl:choose>
				...
				<xsl:otherwise>
					<xsl:text>Spring Cloud Scheduler SPI</xsl:text>
				</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
