= Spring Cloud Scheduler SPI Reference Guide
Glenn Renfro
:doctype: book
:toc:
:toclevels: 4
...
:icons: font
:hide-uri-scheme:
:spring-cloud-scheduler-repo: snapshot
:github-tag: master
:spring-cloud-scheduler-docs-version: current
:spring-cloud-scheduler-docs: http://docs.spring.io/spring-cloud-scheduler/docs/{version}/reference
:spring-cloud-scheduler-docs-current: http://docs.spring.io/spring-cloud-scheduler/docs/current-SNAPSHOT/reference/html/
:github-repo: spring-cloud/spring-cloud-scheduler
...
:dc-ext: html
:dc-root: http://docs.spring.io/spring-cloud-scheduler/docs/{spring-cloud-scheduler-docs-version}/api
